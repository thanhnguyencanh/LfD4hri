...
def parse_args():
	...
	parser.add_argument('--out_filename', default='/home/tuan/Documents/Code/mmaction2/demo'
												  '/saved_video/moving_up_end2222.mp4',help='output filename')
	parser.add_argument(
		'--config',
	...
	parser.add_argument(
		...
		default='/home/tuan/Documents/Code/mmaction2/revised_label_map.txt',
		help='label map file')
	parser.add_argument(
