...
def parse_args():
  ...
  parser.add_argument(
      '--label_map',
      default=f'{ROOT_PATH}/mmaction2/tools/data/sthv2/label_map.txt',
      help='label map file')
