...
# HOME_JOINTS_DEG = [
#     math.degrees(-1.59392155+math.pi / 2),  -math.degrees(0.32993554), math.degrees(-0.88152577),  math.degrees(3.25),        math.degrees(0.34337029), math.degrees(-0.2)
# ]    
...
# Predefined object approach positions (joint angles in degrees)
OBJECTS = {
    'pentagon':  [22.2, -48.4, -63.4, -10.3, -13.4, 31.7],
    'trapezium': [34.2, -31.5, 23.8, 1, 8.5, 34.3],
    'box':       [26.3, -33.7, -41.9, -10.7, -8.6, 31.7],
    'container': [-13.5, -29.7, -38.3, -10.5, -10.8, 31.7],
    'touch':    [3.3, -47.76, -69.75, 183.2, 33.07, -11.5],
}
...
if __name__ == '__main__':
    ...
    try:
        ...
        if obj_name not in OBJECTS:
            ...
            # robot.pick_object(
            #     hover_joints=HOME_JOINTS_DEG,
            #     approach_joints=OBJECTS[obj_name],
            #     place_joints=OBJECTS['container'],
            #     force_threshold=5,
            #     speed=20,
            # )
            robot.touch_object(
                approach_joints=OBJECTS['touch'],
                force_threshold=5,
                speed=20,
            )
