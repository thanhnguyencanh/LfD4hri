...
from models.datd3 import Agent
...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy_name", default="datd3")  # Policy name
    ...
    policy = Agent(state_dim=state_dim, action_dim=action_dim, max_action=max_action, warmup=args.warmup, lr=1e-4,
                   ...
                   noise_clip=args.noise_clip, normalizer=normalizer, chkpt_dir=os.path.join(base, args.checkpoint))
